...
!function (t, e) {
  ...
  t.arrow = t => ({
    ...
    async fn(e) {
      ...
      let k = L ? L[D] : 0;
      k && (await (null == l.isElement ? void 0 : l.isElement(L))) || (k = c.floating[D] || a.floating[b]);
      const C = O / 2 - E / 2,
        B = k / 2 - A[b] / 2 - 1,
        H = o(y[P], B),
        S = o(y[T], B),
    ...
    return void 0 === t && (t = {}), {
      ...
      async fn(e) {
        ...
        const {
          ...
          T = b[P];
        if (null == T) return {};
        const D = h(T, a, await (null == m.isRTL ? void 0 : m.isRTL(d.floating)));
        if (s !== T) return {
          reset: {
            placement: b[0]
          }
    ...
    return void 0 === t && (t = {}), {
      ...
      async fn(e) {
        ...
        const P = c(o),
          T = c(l) === l,
          D = await (null == s.isRTL ? void 0 : s.isRTL(m.floating)),
          O = p || (T || !b ? [w(l)] : function (t) {
            const e = w(t);
            return [y(t), e, y(e)];
          }(l));
        p || "none" === v || O.push(...function (t, e, n, i) {
          const o = u(t);
        ...
        const E = [l, ...O],
          L = await A(e, R),
          k = [];
        let C = (null == (i = r.flip) ? void 0 : i.overflows) || [];
        if (d && k.push(L[P]), g) {
          const t = h(o, a, D);
          k.push(L[t[0]], L[t[1]]);
        }
        if (C = [...C, {
          ...
          var B, H;
          const t = ((null == (B = r.flip) ? void 0 : B.index) || 0) + 1,
            e = E[t];
          if (e) return {
            data: {
              index: t,
          ...
          let n = null == (H = C.filter(t => t.overflows[0] <= 0).sort((t, e) => t.overflows[1] - e.overflows[1])[0]) ? void 0 : H.placement;
          if (!n) switch (x) {
            case "bestFit":
              {
                var S;
                const t = null == (S = C.map(t => [t.placement, t.overflows.filter(t => t > 0).reduce((t, e) => t + e, 0)]).sort((t, e) => t[1] - e[1])[0]) ? void 0 : S[0];
                t && (n = t);
                break;
              }
    ...
    return void 0 === t && (t = {}), {
      ...
      async fn(e) {
        ...
        let D = R,
          O = P;
        if (y) {
          const t = w - d.left - d.right;
          O = h || T ? o(P, t) : t;
        } else {
          const t = x - d.top - d.bottom;
          D = h || T ? o(R, t) : t;
        }
        if (T && !h) {
          const t = r(d.left, 0),
            ...
            n = r(d.top, 0),
            i = r(d.bottom, 0);
          y ? O = w - 2 * (0 !== t || 0 !== e ? t + e : r(d.left, d.right)) : D = x - 2 * (0 !== n || 0 !== i ? n + i : r(d.top, d.bottom));
        }
        await s({
          ...e,
          availableWidth: O,
        ...
        const E = await a.getDimensions(l.floating);
        return w !== E.width || x !== E.height ? {
          reset: {
            rects: !0
          }
        } : {};
